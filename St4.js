...
//Textura
		...
		var	Material_cubo11=new THREE.MeshBasicMaterial({map:Textura_cubo11});
					
			var		Territorio11=new THREE.Mesh(cubo11,Material_cubo11);

  Territorio11.position.x =-130+l11*10;
  Territorio11.position.z=-k11*10;
  Territorio11.position.y=80;
