...
{
var cubo11= new THREE.Mesh( new THREE.BoxGeometry(10,10,-10));
  cubo11.position.x =-130+l11*10;
  cubo11.position.z=-k11*10;
  cubo11.position.y=120;
  escena.add(cubo11);
}
}
escena.add(reyMalla);
